...
class Job extends \AppBundle\Entity\Job implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\Job' . "\0" . 'location', '' . "\0" . 'AppBundle\\Entity\\Job' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\Job' . "\0" . 'company', '' . "\0" . 'AppBundle\\Entity\\Job' . "\0" . 'category');
        }
